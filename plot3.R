...
with(df, plot(df$datetime, df$Sub_metering_1, type="l", xaxt="n", xlab="", ylab = "Energy Sub Metering"))
par(new=TRUE)
with(df, lines(df$datetime, df$Sub_metering_2, type="l",col="red"))
with(df, lines(df$datetime, df$Sub_metering_3, type="l",col="blue"))
